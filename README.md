...
running command...
$ mcp-eval (--version)
mcp-eval/0.0.0 darwin-arm64 node-v22.17.1
...
_See code: [src/commands/hello/index.ts](https://github.com/alpic-ai/mcp-eval/blob/v0.0.0/src/commands/hello/index.ts)_
...
_See code: [src/commands/hello/world.ts](https://github.com/alpic-ai/mcp-eval/blob/v0.0.0/src/commands/hello/world.ts)_
